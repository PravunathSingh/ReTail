...
const DATA_HTML = `<button className='btn btn-rounded btn-primary'>Primary</button>
...
<button className='btn btn-rounded btn-dark'>Dark</button>
`;
...
const DATA_CSS = `@layer components {
  ...
  // other styles for the classNames of btn and btn-primary, btn-success, btn-info, btn-danger and btn-dark remains same as above
}`;
